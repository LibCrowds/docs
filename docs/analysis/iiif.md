...
There are currently two main types of annotation generated by IIIF Annotation
projects, selections and transcriptions, where the former will often be used
to generate tasks for the latter.

Comments are also tracked as annotations and target the image as a whole,
rather than a specific section of it.
